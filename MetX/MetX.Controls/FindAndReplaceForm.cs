...
namespace MetX.Controls
{
    public partial class FindAndReplaceForm : Form
    {
        ...
        public TextRange FindNext(bool viaF3, bool searchBackward, string messageIfNotFound)
        {
            ...
            {
                Host.MessageBox.Show("No string specified to look for!");
                return null;
            }
            ...
            if (range != null)
                ...
                Host.MessageBox.Show(messageIfNotFound);
            return range;
        }
        ...
        private void btnHighlightAll_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (count == 0)
                    Host.MessageBox.Show("Search text not found.");
                else
                    Close();
            }
        }
        ...
        private void btnReplaceAll_Click(object sender, EventArgs e)
        {
            ...
            if (count == 0)
            {
                Host.MessageBox.Show("No occurrences found.");
            }
            else
            {
                Host.MessageBox.Show($"Replaced {count} occurrences.");
                Close();
            }
        }
