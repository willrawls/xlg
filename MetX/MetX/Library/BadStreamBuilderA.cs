...
namespace MetX.Library
{
    ...
    /// </summary>
    public class BadStreamBuilder
    {
        public static StreamBuilder CreateInstance(StringBuilder targetStringBuilder)
        {
            return new StreamBuilder(targetStringBuilder);
        }
...
#1#
        ...
        /// <param name="textWriter"></param>
        /// <param name="underlyingStream"></param>
        private StreamBuilder(StringBuilder targetStringBuilder)
        {
...
#1#
        ...
        /// </summary>
        public void Finish(bool leaveStreamOpen)
        {
            FinishCount++;
            try
            {
                Target?.Flush();
                if (leaveStreamOpen || !CloseOnFinish) return;
                Target?.Close();
            }
