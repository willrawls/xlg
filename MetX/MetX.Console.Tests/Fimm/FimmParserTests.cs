...
[TestClass]
public class FimmParserTests
{
    private const string Fimm_TemplateAreaBeginProcessingArea = @"
~~Template:
    string x = ""Ding"";
...
");
    ...
    {
        var data = new FimmParser();
        data.Parse(Fimm_TemplateAreaBeginProcessingArea);
